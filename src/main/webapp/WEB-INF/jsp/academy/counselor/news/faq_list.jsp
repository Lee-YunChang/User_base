            ...
            <section>
            	<div class="bluelineTabWrap">
                	<ul class="bluelineTab free">
                		<li class="<c:if test="${REQUEST_DATA.tabNo == 0 || REQUEST_DATA.tabNo == null}"> active</c:if>"><a title="전체" href="#none" onclick="fnTab('/academy/counselor/faqList.do', '0'); return false;">전체</a></li>
                		<li class="<c:if test="${REQUEST_DATA.tabNo == 1}"> active</c:if>"><a title="회원정보 관련" href="#none" onclick="fnTab('/academy/counselor/faqList.do', '1'); return false;">회원정보 관련</a></li>
					 	<li class="<c:if test="${REQUEST_DATA.tabNo == 2}"> active</c:if>"><a title="심화상담 관련" href="#none" onclick="fnTab('/academy/counselor/faqList.do', '2'); return false;">심화상담 관련</a></li>
						<li class="<c:if test="${REQUEST_DATA.tabNo == 3}"> active</c:if>"><a title="상담전문가 관련" href="#none" onclick="fnTab('/academy/counselor/faqList.do', '3'); return false;">상담전문가 관련</a></li>
		                ...
		                <div class="panel">
		                    ...
		                    <div id="qna${status.count}Panel" class="panel-collapse collapse">
		                        <div class="panel-body">
		                            ...
		                            <div class="po_C8 control_word"><c:out value="${result.CONTENT}" escapeXml="false"/></div>
		                          </div>
		                    </div>
		                </div>
		            </c:forEach>
