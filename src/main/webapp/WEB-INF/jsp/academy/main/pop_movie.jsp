...
$(document).ready(function(){
	...
	if (isANDROID || isIOS) {
		...
		videoSeek.src = "http://112.175.102.51:1935/vod/_definst_/intro/intro.mp4/playlist.m3u8";
		videoSeek.play();
		...
		$('.jp-no-solution').show();
		 jwplayer('player').setup({
			...
			//file: "rtmp://112.175.102.51:1935/vod/mp4:99/01/01.mp4",
			 file: "rtmp://112.175.102.51:1935/vod/mp4:intro/intro.mp4",
