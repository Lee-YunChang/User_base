	...
	<article class="subArea">
		...
		<div class="subConts" id="sub-content">
			<section class="contTop">   
                <h2 class="h2_tit">설문 <span class="ico_sec syber">온라인교육</span> <span class="po_C7 fnt12"><c:out value="${REQUEST_DATA.ctypeName}"/> <c:out value="${REQUEST_DATA.seqTitle}"/></span></h2>
            </section>
					...
					<c:forEach var="questionList" items="${questionList}"	varStatus="status2">
						<c:if test="${moduleList.CPOLL_TITLE == questionList.CPOLL_TITLE}">
								...
								<c:if test="${questionList.MT_CPOLL_CODE eq 'JBAA00'}">
									...
									<input type="text" class="form-control testInput" id="l-school" textQno="${questionList.QNO}"  name="${questionList.QNO}" title="주관식 정답 입력">
