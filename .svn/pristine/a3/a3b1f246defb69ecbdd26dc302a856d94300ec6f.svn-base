...
function move_page(cPage){
	...
	$('form[name=frm]').attr('action', '<c:out value="${ctx}"/>/academy/counselor/helpdesk/boardDataList.do').submit();
} 
		...
		<div class="subCntWrap">
			...
			<div class="path">
                <ul>
                    ...
                    <li>알림마당</li>
                    <li class="active"><c:out value="${REQUEST_DATA.title}"/></li>
                </ul>
            </div>
			<div class="subConts" id="sub-content">
				<section class="bgTop_cate04"><!--   카테고리별 이미지 추가  -->
            		<div class="contTop">
            			<h2 class="h2_tit"><c:out value="${REQUEST_DATA.title}"/></h2>
            		</div>           	
	            </section>
