    ...
    function html5Upload() {
        ...
        sUploadURL= '/academy/common/smarteditor/photo_uploader/popup/uploadfile.jsp'; 	//upload URL
    ...
    function onAjaxError (){
     ...
     function callFileUploader (){
         oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
        	 sUrl  : '/academy/common/smarteditor/photo_uploader/popup/uploadfile.jsp',
